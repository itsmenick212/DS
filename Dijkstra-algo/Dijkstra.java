...
public class Dijkstra {
  ...
  public void doDijkstra(String s) 
  {
	    ...
	    while (!list.isEmpty()) 
	    {
	      Vertex minimumVertex = list.getFirst();
	      for (Vertex vertex : list) 
	      {
	        if (vertex.distance < minimumVertex.distance) 
	        {
	          minimumVertex = vertex;
	        }
	      }
	      list.remove(minimumVertex);
  ...
  public List<Edge> getDijkstraPath(String s, String t) 
  {
    ...
    // Here, you're following the backpointers and inserting the edges
    while (v.prev != null) 
    {
    ...
    double overallDistance = result.stream().mapToDouble(x -> x.distance).sum();
    System.out.println("The overall distance is " + overallDistance + ".");
